...
class Market(dict):
    """ This class allows to easily access Markets on the blockchain for trading, etc.
        ...
        * ``base-quote`` separated with ``-``
        ...
        .. note:: Throughout this library, the ``quote`` symbol will be
                  presented first (e.g. ``USD:X4T`` with ``USD`` being the
    ...
    def get_string(self, separator=":"):
        """ Return a formated string that identifies the market, e.g. ``USD:X4T``
    ...
    def ticker(self):
        """ Returns the ticker for all markets.
            ...
            * ``core_exchange_rate``: Core exchange rate for payment of fee in non-X4T asset
    ...
    def orderbook(self, limit=25):
        """ Returns the order book for a given market. You may also
            ...
            .. code-block:: js
                ...
                {'bids': [0.003679 USD/X4T (1.9103 USD|519.29602 X4T),
                0.003676 USD/X4T (299.9997 USD|81606.16394 X4T),
                0.003665 USD/X4T (288.4618 USD|78706.21881 X4T),
                0.003665 USD/X4T (3.5285 USD|962.74409 X4T),
                0.003665 USD/X4T (72.5474 USD|19794.41299 X4T)],
                'asks': [0.003738 USD/X4T (36.4715 USD|9756.17339 X4T),
                0.003738 USD/X4T (18.6915 USD|5000.00000 X4T),
                0.003742 USD/X4T (182.6881 USD|48820.22081 X4T),
                0.003772 USD/X4T (4.5200 USD|1198.14798 X4T),
                0.003799 USD/X4T (148.4975 USD|39086.59741 X4T)]}
    ...
    def buy(
        ...
        **kwargs
        ...
        """ Places a buy order in a given market
            ...
            Prices/Rates are denoted in 'base', i.e. the USD_X4T market
            is priced in X4T per USD.

            **Example:** in the USD_X4T market, a price of 300 means
            a USD is worth 300 X4T

            .. note::

                All prices returned are in the **reversed** orientation as the
                market. I.e. in the BTC/X4T market, prices are X4T per BTC.
            ...
            .. warning::
                ...
                for. Example:
                    ...
                    * You place and order to buy 10 USD for 100 X4T/USD
                    * This means that you actually place a sell order for 1000 X4T in order to obtain **at least** 10 USD
