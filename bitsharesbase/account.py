...
class Address(GPHAddress):
    """ Address class
        ...
        :param str prefix: Network prefix (defaults to ``X4T``)

        Example::

           Address("X4TFN9r6VYzBK8EKtMewfNbfiGCr56pHDBFi")
...
class PublicKey(GPHPublicKey):
    """ This class deals with Public Keys and inherits ``Address``.
        ...
        Example:::
           ...
           PublicKey("X4T6UtYWWs3rkZGV8JA86qrgkG6tyFksgECefKE1MiH4HkLD8PFGL")
