    ...
    def test_create_account(self):
        self.op = operations.Account_create(**{
            ...
            "owner": {"weight_threshold": 1,
                      "account_auths": [],
                      'key_auths': [['X4T6pbVDAjRFiw6fkiKYCrkz7PFeL7XNAfefrsREwg8MKpJ9VYV9x',
                                    1], [
                                    'X4T6zLNtyFVToBsBZDsgMhgjpwysYVbsQD6YhP3kRkQhANUB4w7Qp',
                                    1]],
                      "address_auths": []
                      },
            "active": {"weight_threshold": 1,
                       ...
                       'key_auths': [['X4T6pbVDAjRFiw6fkiKYCrkz7PFeL7XNAfefrsREwg8MKpJ9VYV9x',
                                     ...
                                     'X4T6zLNtyFVToBsBZDsgMhgjpwysYVbsQD6YhP3kRkQhANUB4w7Qp',
                                     1], [
                                     'X4T8CemMDjdUWSV5wKotEimhK6c4dY7p2PdzC2qM1HpAP8aLtZfE7',
                                     1
                                     ]],
                       "address_auths": []
                       },
            "options": {"memo_key": "X4T5TPTziKkLexhVKsQKtSpo4bAv5RnB8oXcG4sMHEwCcTf3r7dqE",
        ...
        self.op = operations.Account_update(
            **{
                ...
                "owner": {
                    ...
                    "key_auths": [
                        ["X4T6pbVDAjRFiw6fkiKYCrkz7PFeL7XNAfefrsREwg8MKpJ9VYV9x", 1]
                    ],
                    "address_auths": [],
                },
                "active": {
                    ...
                    "account_auths": [["1.2.96086", 1]],
                    "key_auths": [
                        ["X4T8CemMDjdUWSV5wKotEimhK6c4dY7p2PdzC2qM1HpAP8aLtZfE7", 1]
                    ],
                    "address_auths": [],
                },
                "new_options": {
                    "memo_key": "X4T5TPTziKkLexhVKsQKtSpo4bAv5RnB8oXcG4sMHEwCcTf3r7dqE",
                    "voting_account": "1.2.5",
                    "num_witness": 0,
                    "num_committee": 0,
                    "votes": [],
    ...
    def test_witness_update(self):
        self.op = operations.Witness_update(
            **{
                ...
                "new_signing_key": "X4T5vfCLKyXYb44znYjbrJXCyvvx3SuifhmvemnQsdbf61EtoR36z",
            }
        )
        self.cm = (
    ...
    def test_balance_claim(self):
        self.op = operations.Balance_claim(
            **{
                ...
                "balance_owner_key": "X4T7YFfmNBLpcrhe7hf39NLQfgBjGvtYBtAAc4nDvZKWxVQjF4CeL",
